# main.py
#
# This module holds functions for the command line.
...
# Calls the correct function depending on args.command
def main(args):
...
# Parses sys.argv and passes it to main (called when __main__)
